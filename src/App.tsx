...
function App() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-black w-full overflow-x-hidden selection:bg-white selection:text-black relative">
      {/* Global Navigation */}
      <Header />

      <Suspense fallback={<div className="min-h-screen bg-black flex items-center justify-center text-white font-sans tracking-widest text-[12px] uppercase">Loading...</div>}>
        {currentPage === 'home' ? (
          <>
