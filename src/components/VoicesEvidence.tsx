...
const VideoCard = ({ src, name, title, objectPosition = 'object-center' }: VideoCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-6 left-6 right-6 z-20 pointer-events-none flex flex-col gap-1">
        ...
        <span className="font-sans text-[14px] text-[#c0c0c0]">{title}</span>
      </div>
    </button>
  );
};
...
export default function VoicesEvidence() {
  ...
  return (
    <section
      id="the-invisible"
      ref={containerRef}
      className="w-full bg-[#000000] pt-[48px] pb-[128px] flex flex-col items-center scroll-mt-[100px]"
    >
      {/* Section Header */}
